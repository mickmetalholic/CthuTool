...
description: Reference entry points for commands, configuration, APIs, repository maps, and OpenSpec.
---

Reference pages collect stable lookup material. Start with task-oriented pages when installing or operating CthuTool, then use reference pages for exact paths and commands.
...
| [GitOps](/reference/gitops/) | CthuOps-owned deployment resources, ArgoCD Applications, and image delivery |
...
| [OpenSpec Index](/capability-specs/) | Current capability spec list |
