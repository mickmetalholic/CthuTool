...
Define the CthuDesktop task center that surfaces pending user actions, beginning with browser authentication tasks that can be resolved from the desktop app.
