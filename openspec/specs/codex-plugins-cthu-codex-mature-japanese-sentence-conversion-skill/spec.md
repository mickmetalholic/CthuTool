# codex-plugins-cthu-codex-mature-japanese-sentence-conversion-skill Specification

## Purpose
Define the CthuCodex explicit-only workflow for safely converting mature FSRS-selected Japanese Sentence notes into whole-sentence production clozes.
