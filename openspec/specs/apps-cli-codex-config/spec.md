## Purpose
Define apps/cli behavior for reproducible Codex configuration maintenance, personal plugin installation, safe repository-managed Codex state, and machine-readable output.
