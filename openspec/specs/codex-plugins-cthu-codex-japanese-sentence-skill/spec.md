# codex-plugins-cthu-codex-japanese-sentence-skill Specification

## Purpose
Specify the CthuCodex plugin-local skill for creating `Japanese Sentence` Anki notes from Japanese example sentences and grammar points.
