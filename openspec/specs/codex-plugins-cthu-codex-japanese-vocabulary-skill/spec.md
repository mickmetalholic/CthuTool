# codex-plugins-cthu-codex-japanese-vocabulary-skill Specification

## Purpose
Specify the CthuCodex plugin-local skill for creating `Japanese Vocabulary` Anki notes from Japanese example sentences and vocabulary targets.
