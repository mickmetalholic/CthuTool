# apps-cli-opencode-shared-assets Specification

## Purpose
Repository-owned Codex plugin skills and MCP servers synchronized into OpenCode configuration through explicit CLI commands.
## Requirements
