# apps-backend-browser-public-api Specification

## Purpose
The backend public browser API exposes trusted third-party browser session and
action workflows while preserving desktop ownership of Playwright runtime state.
