...
- **AND** the context states that OpenSpec skills under `.agents/skills` and
  `.zcode/skills` are checked-in generated outputs that should be regenerated
  rather than hand-edited for project policy
