...
- **AND** the context states that generated OpenSpec adapters under
  `.agents/skills`, `.cursor/skills`, and `.opencode/skills` are reproducible
  outputs that should be regenerated rather than hand-edited for project policy
