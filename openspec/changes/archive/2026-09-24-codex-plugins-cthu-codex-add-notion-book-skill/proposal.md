...
- Add `notion-manage-books` to the CthuCodex business plugin, using the existing `notion-` naming family and explicit-only invocation.
...
- This change explicitly targets the business plugin. Generated OpenSpec adapters, other skills, unrelated changes, and live Notion records remain outside this planning work. Plugin installation or publication is not part of this change.
