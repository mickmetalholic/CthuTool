...
- [ ] 5.6 After merge, reinstall `cthu-codex@personal` and perform any explicitly authorized live Notion creation test from a Xiaohongshu URL or selected tab, recording the resulting page for review.
